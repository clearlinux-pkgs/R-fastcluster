...
Version  : 1.3.0
Release  : 65
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/fastcluster_1.3.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/fastcluster_1.3.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746715972
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/fastcluster/libs/fastcluster.so
/V4/usr/lib64/R/library/fastcluster/libs/fastcluster.so
