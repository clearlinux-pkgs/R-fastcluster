...
Version  : 1.2.2
Release  : 44
URL      : https://cran.r-project.org/src/contrib/fastcluster_1.2.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/fastcluster_1.2.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621868362
